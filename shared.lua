...
--      formspec = formspec .. pipeworks.button_label
...
local function get_chest_formspec(pos, large_flag)
    ...
    if not large_flag then
        ...
        formspec =
            ...
            default.get_hotbar_bg(0, 4.85 - dy + pw_dy)

    else

        -- "large" chest variant. Original to twchests
        ...
        formspec =
            ...
            "listring[nodemeta:" .. pos_str .. ";main]" ..
            "listring[current_player;main]" ..
            default.get_hotbar_bg(column, 4.35 + dy + pw_dy + 1)
...
function twchests.register_chest(data_table)

    -- Adapted from default/chests.lua
    -- Create a chest with a specified capacity
    --
    -- This function creates two types of chest, based on the chests in minetest-game:
    --      - A "small" chest with a capacity of 8x4, or smaller (e.g. the "compact" chest in
    --          chest_compact.lua). The chest's inventory is displayed on a single formspec page
    --      - A "large" chest with a capacity of 8x4, or larger (e.g. the "bottomless" chest in
    --          chest_bottomless.lua). The chest's inventory is displayed on multiple formspec
    --          pages. The chest can have limited or a limitless capacity
    --
    -- Chests created by this function behave like chests in minetest-game: they can have locked
    ...
    local full_name = "twchests:chest_" .. part_name
    ...
    if def_table.tiles and pipeworks_flag then
        ...
        for i = 1, 4 do
            ...
            def_table.tiles[i] = def_table.tiles[i] .. "^twchests_tube_connection_wooden.png"
    ...
    minetest.register_node(full_name, def_closed)
    minetest.register_node(full_name .. "_open", def_opened)
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    ...
    if string.find(formname, "twchests:chest_") == nil or not player then
        return
    end
